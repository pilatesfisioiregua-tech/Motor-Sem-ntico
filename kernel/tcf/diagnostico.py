...
from kernel.tcf.campo import VectorFuncional, EstadoCampo
from kernel.tcf.constantes import UMBRAL_LENTE_ALTA, UMBRAL_LENTE_BAJA
from kernel.tcf.flags import FlagPeligro, detectar_todos_flags

if TYPE_CHECKING:
    from motor.repertorio import RepertorioCognitivo
...
class DiagnosticoCompleto:
    ...
    repertorio usa Any en runtime para evitar import circular con motor/.
    En TYPE_CHECKING se resuelve a motor.repertorio.RepertorioCognitivo.
    """
    # P1: Vector funcional
    ...
    # P4: Repertorio cognitivo INT×P×R (motor.repertorio.RepertorioCognitivo)
