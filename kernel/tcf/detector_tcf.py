...
from kernel.tcf.campo import VectorFuncional, EstadoCampo, evaluar_campo
from kernel.tcf.arquetipos import (
    ScoringMultiArquetipo,
    FirmaDetectada,
    scoring_multi_arquetipo,
    pre_screening_linguistico,
)
from kernel.tcf.recetas import RecetaResultado, generar_receta_mixta
...
def estimar_vector_desde_firmas(
    ...
    from kernel.tcf.constantes import ARQUETIPOS_CANONICOS, FUNCIONES
