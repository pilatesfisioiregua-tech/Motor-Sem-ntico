...
|------|-----------|-------------|--------|---------|-------|
| T1 Quick (read+report) | ✅ PASS | 0 | 0.5s | 0 | Tools: [] / Summary: No pude completar la tarea tras 0 pasos. Razon: CACHE_HIT.  |
| T2 Análisis (listar métodos) | ✅ PASS | 0 | 0.3s | 0 | Métodos encontrados: 5/6 |
| T3 Execute (crear endpoint) | ❌ FAIL | 7 | 17.8s | 1 | Edit calls: 0 / Total tools: 7 / Tools: ['mochila', 'http_request', 'http_reques |
| T4 Deep (diagnóstico) | ✅ PASS | 10 | 18.8s | 1 | HTTP calls: 6 / Keywords diagnóstico: 2/6 / Tools: ['mochila', 'http_request', ' |
...
- Tiempo: 17.8s
- Errores: 1
- Notas: Edit calls: 0 | Total tools: 7 | Tools: ['mochila', 'http_request', 'http_request', 'http_request', 'db_query', 'db_query', 'db_query']
...
- Tiempo: 18.8s
- Errores: 1
- Notas: HTTP calls: 6 | Keywords diagnóstico: 2/6 | Tools: ['mochila', 'http_request', 'http_request', 'http_request', 'http_request', 'http_request', 'http_request', 'db_query', 'db_query', 'db_query']
