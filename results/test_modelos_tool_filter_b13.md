...
| T2 Análisis (listar métodos) | ✅ PASS | 0 | 0.6s | 0 | Métodos encontrados: 5/6 |
| T3 Execute (crear endpoint) | ❌ FAIL | 6 | 15.0s | 0 | Edit calls: 0 / Total tools: 6 |
| T4 Deep (diagnóstico) | ❌ FAIL | 24 | 253.2s | 2 | HTTP calls: 8 / Keywords diagnóstico: 1/6 |
...
- Tiempo: 253.2s
- Errores: 2
- Notas: HTTP calls: 8 | Keywords diagnóstico: 1/6
